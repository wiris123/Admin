...
var GB = {
    ...
    popupWindow: {
        ColorPicker :   {tmpl : 'color_picker.html',    width : 420, title : '���� ����'},
        Embed :         {tmpl : 'media.html',           width : 430, title : '�̵��'},
        EmotionIcon :   {tmpl : 'icon.html',            width : 300, title : 'ǥ�� ������'},
        FlashMovie :    {tmpl : 'flash.html',           width : 584, title : '�÷��� ������'},
        GoogleMap :     {tmpl : 'google_map.html',      width : 538, title : '���� ����'},
        ImageUpload :   {tmpl : 'image.html',           width : 700, title : '�� PC ���� �ֱ�'},
        ImageUrl :      {tmpl : 'image_url.html',       width : 350, title : '�� ���� �ֱ�'},
        Layout :        {tmpl : 'layout.html',          width : 430, title : '���̾ƿ�'},
        Link :          {tmpl : 'link.html',            width : 350, title : '�����۸�ũ'},
        ModifyTable :   {tmpl : 'table_modify.html',    width : 430, title : 'ǥ ��ġ��'},
        Symbol :        {tmpl : 'symbol.html',          width : 450, title : 'Ư�� ����'},
        Table :         {tmpl : 'table.html',           width : 430, title : 'ǥ �����'}
    },
    fontName: {
        kr : ['���� ���', '����', '����', '����', '�ü�'],
    ...
    listStyle: {
        ordered: {
            decimal: '����', 'lower-alpha': '���� �ҹ���', 'upper-alpha': '���� �빮��', 'lower-roman': '�θ� �ҹ���', 'upper-roman': '�θ� �빮��'
        },
        unOrdered: {desc: '���׶��', circle: '�� ��', square: '�簢��'}
    },
    fontSize: {
    ...
    lineHeight: {
        '�� �� ����': 1, '1.15': 1.15, '1.5': 1.5, '1.7': 1.7, '1.8': 1.8, '�� �� ����': 2
    },
    textBlock: [
...
function setConfig() {
    var config = {
        ...
        editorBgColor       : '#fff',
        editorFontColor     : '#000',
        editorFontName      : '"���� ���", "Malgun Gothic", gulim',
        editorFontSize      : '12px',
        editorHeight        : '300px',
        editorPath          : null,
        editorWidth         : '100%',
        ...
        imgJpegQuality      : 0.92,     // JPEG ������ ����Ƽ ��, �ִ밪 1
        imgMaxWidth         : 800,      // ���� �ִ� ���� ũ��, �� ũ�� ���� ũ�� ������¡ ó��
        imgResizeMinLimit   : 32,       // ���� ������¡�� ����� ���� �Է� ���� �� �� ���� ������, �� ������ ����
        imgResizeSelected   : 800,      // ���� ������¡�� ���� �Է� ���� �⺻ ���� ��
        imgResizeValue      : [120, 240, 320, 640, 800, -1], // -1 = ����� ���� �Է�
        imgSetAttrAlt       : true,
        imgSetAttrWidth     : 1,        // -1 = (width="100%"; height="auto"), 0 = ���� ����, 1 = �⺻��
        imgUploadNumber     : 12,
        imgUploadSortName   : false,
        imgWaterMarkAlpha   : 1,        // ���͸�ũ ������ (�ִ밪 1)
        imgWaterMarkUrl     : '',       // ���͸�ũ �̹��� URL (��: 'http://udomain.com/cheditor/icons/watermark.png')
        includeHostname     : true,
        lineHeight          : 1.7,
        linkTarget          : '_blank',
        makeThumbnail       : false,    // ������ ����� �̹��� ����, ���� ũ��� thumbnailWidth ��, ���δ� �ڵ� ���
...
function cheditor() {
    ...
    if (this.browser.msie && this.browser.version < 7) {
        alert('CHEditor�� Internet Explorer 7 ���� ������ �������� �ʽ��ϴ�.');
        return null;
    }
...
cheditor.prototype = {
    ...
    checkInputForm : function () {
        ...
        if (!textarea) {
            throw 'ID�� "' + this.inputForm + '"�� textarea ��ü�� ã�� �� �����ϴ�.';
        }
        ...
        for (i in toolbar) {
            ...
            switch (cmd) {
                ...
                case 'FormatBlock' :
                    ...
                    if (!el) {
                        span.appendChild(document.createTextNode('��Ÿ��'));
                        wrapper.replaceChild(span, oldName);
                    }
    ...
    showToolbar : function (toolbar, toolbarWrapper) {
        var self = this,
            ...
            onClickEventHandler = function () {
                if (self.setFullScreenMode) {
                    ...
                    this.setAttribute('title', '��ü ȭ��');
                } else {
                    this.className = 'cheditor-tb-fullscreen-actual';
                    this.setAttribute('title', '���� ũ��� ����');
                }
                self.fullScreenMode();
            };
        ...
        if (self.config.useFullScreen === true) {
            ...
            fullscreen.setAttribute('title', '��ü ȭ��');
            (function () {
    ...
    doCmd : function (cmd, opt) {
        ...
        if (!GB.browser.msie && (cmd === 'Cut' || cmd === 'Copy' || cmd === 'Paste')) {
            if ((range.execCommand(cmd, false, opt)) !== true) {
                ...
                alert('����ϰ� ��� �������� ���� ���� ������ \'' + command + '\' ����� ����Ͻ� �� �����ϴ�. \n\n' +
                'Ű���� ����Ű�� �̿��Ͽ� �ֽʽÿ�.\n����Ű: Windows: Ctrl+' + keyboard + ', Mac OS X: Command+' + keyboard);
                this.editAreaFocus();
    ...
    modifyImage : function (img) {
        var self = this,
            ...
            captionAlignOpt = { left: '����', center: '���', right: '������' },
            imageFloatOpt = {
                left : {
                    value : '����',
                    input : null
        ...
        div.appendChild(document.createTextNode('Ÿ��Ʋ:'));
        ...
        div.appendChild(document.createTextNode('���� ĸ��:'));
        ...
        div.appendChild(document.createTextNode('ĸ�� �ؽ�Ʈ ����:'));
    ...
    modifyCell : function (ctd) {
        var self = this,
            ...
            funcs = {
                add_cols_after: { icon: 'table_insert_column.png', title: '�� ����',
                    func: function () {
                        insertColumn(ctd.cellIndex); tblReflash();
                    }},
                add_rows_after: { icon: 'table_insert_row.png', title: '�� ����',
                    func: function () {
                        insertRow(ctr.rowIndex); tblReflash();
                    }},
                remove_cols: { icon: 'table_delete_column.png', title: '�� ����',
                    func: function () {
                        deleteColumn(ctd.cellIndex); tblReflash();
                    }},
                remove_rows: { icon: 'table_delete_row.png', title: '�� ����',
                    func: function () {
                        deleteRow(); tblReflash();
                    }},
                sp1: { icon: 'dot.gif' },
                merge_cell_right: { icon: 'table_join_row.png', title: '������ ���� ����',
                    func: function () {
                        mergeCellRight(); tblReflash();
                    }},
                merge_cell_down: { icon: 'table_join_column.png', title: '�Ʒ� ���� ����',
                    func: function () {
                        mergeCellDown(); tblReflash();
                    }},
                split_cell_v: { icon: 'table_split_row.png', title: '�� ���� ������',
                    func: function () {
                        splitCellVertical(); tblReflash();
                    }},
                split_cell_h: { icon: 'table_split_column.png', title: '�� ������ ������',
                    func: function () {
