...
<!-- 검색폼 -->
<form action="./proc/email_write_proc.jsp" name="mwriteForm" method="get" id="mform">
	...
	<table width="100%"border="0" cellpadding="10" cellspacing="0" class="top5">
		<tr>
	  		<td width="8%"><input type="hidden" name="" value=""/>
				...
				<button type="button" class="h22 t4 small icon gray" id="savebutton" onClick="location.href='form_list_email.jsp?flag=e'">
