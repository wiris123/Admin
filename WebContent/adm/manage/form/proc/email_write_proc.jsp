...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	String mobile = request.getParameter("mobile")/* +"-"+request.getParameter("mobile2")+"-"+request.getParameter("mobile3") */;
		...
		if(affected==1)
		{ 
			response.sendRedirect("../form_list_email.jsp?flag="+flag);
		}
		else
		{
	%>
