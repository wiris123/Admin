...
<div id="Header">
   <h1><a href="../main/main.html" onFocus="this.blur();"><img src="../image/header/logo.png" /></a></h1>
    ...
    <div id="navi">
       <li class="design">
         ...
         <a href="../bbs/bbs_list.html" onFocus="this.blur();"><span>게시판관리</span></a>             
           <ul class="category">
            ...
            <li>
         <a href="../member/member_list.html" onFocus="this.blur();"><span>회원관리</span></a>
         <ul class="category">
            <li>
               <a href="../member/member_list.html">회원목록</a>
            </li>

            <li>
               <a href="../member/level_list.html">회원등급</a>
            </li>

            <li>
               <a href="../member/out_list.html">탈퇴회원</a>
            </li>
         ...
         <ul class="category">
            ...
            <li>           
         <a href="../connect/connect_list.html" onFocus="this.blur();"><span>접속통계</span></a>
           <ul class="category">
            <li>
               <a href="../connect/connect_list.html">접속자분석</a>
            </li>
      ...
      <li>           
         <a href="prd_list.html" onFocus="this.blur();"><span>상품관리</span></a>
           <ul class="category">
            <li>
               <a href="prd_list.html">상품목록</a>
            </li>

            <li>
               <a href="prd_input.html">상품등록</a>
            </li>
...
<ul id="Lnb">
    <li class="on"><a href="prd_list.html" onFocus="this.blur();">상품관리</a>
        <ul>
         <li class="">
            <a href="prd_list.html">상품목록</a>
         </li>
...
<div id="prdlay5" style="display:none">
   ...
   <tr>
      ...
      <td colspan="3">
         ...
         <tr>
            <td width="100%">
               <iframe width="99%" height="95" frameborder="0" src="prd_relationc283.html?mode=insert&amp;prdcode="></iframe>
            </td>
         </tr>
         </table>
      </td>
...
content.run();                                                 // 에디터를 실행합니다.
   ...
   <tr>
      <td align="center">
         ...
         <button style="border:0" type="button" class="b h28 t5 color gray_big" onClick="document.location='prd_list13c2.html?page=&amp;dep_code=&amp;dep2_code=&amp;dep3_code=&amp;searchopt=&amp;searchkey=';">목록</button>
      </td>
   </tr>
   </table>
   </form>
