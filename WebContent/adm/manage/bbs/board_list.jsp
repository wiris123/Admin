...
<!-- 리스트 반복 -->		
					<tr style="">
						...
						<td align="left"
							style="padding-left: 10px; word-break: break-all;"><a href='freeboard.jsp?ptype=view&amp;idx=5275&amp;page=1&amp;code=bbsBasic'>[카테고리1] 게시물
								테스트 입니다. 게시물 테스트 입니다. ...</a> (1)
						</td>
				...
				<div class="AWbbs_f_search">
					<table width="0%" border="0" cellpadding="0" cellspacing="0"
						...
						<form name="sfrm"
							...
							<input type="hidden" name="code" value="bbsBasic"> <input
