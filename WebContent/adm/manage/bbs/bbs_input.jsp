    ...
    -->
		...
		<div id="Container">
            ...
            -->
							...
							<td colspan="3">
								<table width="98%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<th width="20%">글쓰기</th>
										<th width="20%">답글쓰기</th>
										<th width="20%">코멘트쓰기</th>
									</tr>
									<tr>
										<td><select name="lpermi">
						...
						<tr>
							<th rowspan="2" height="10" align="left">권한이 없을경우</th>
							<td colspan="3">경고메세지 : <input name="permsg" type="text"
								size="30" value="권한이 없습니다." class="input">&nbsp; 경고후
								이동페이지 : <input name="perurl" type="text" size="30" value=""
								class="input">
							</td>
						</tr>
						<tr>
							<td colspan="3"><input type="radio" name="btn_view"
								value="N" checked> 글쓰기 버튼이 보이지 않음 <input type="radio"
								name="btn_view" value="Y"> 글쓰기 버튼이 보이고 클릭 시 경고창</td>
						</tr>
						<tr>
							<th height="10" align="left">이미지크기</th>
							<td colspan="3">목록페이지 : <input name="simgsize" type="text"
								size="9" value="120" class="input">픽셀 &nbsp; 보기페이지 : <input
								name="mimgsize" type="text" size="9" value="600" class="input">픽셀
							</td>
						</tr>
						<tr>
