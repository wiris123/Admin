...
<body class="home_body">
	<div id="Header">
		<h1>
			<a href="main.html" onFocus="this.blur();"><img src="../image/header/logo.png" /></a>
		</h1>
		<ul id="gnb">
			<li class="first"><a target="_blank"
				href="http://demohome.anywiz.co.kr/" onFocus="this.blur();">내홈페이지</a></li>
			<li><a href="main.html" onFocus="this.blur();">관리자홈</a></li>
			<li><a href="../../logout.html" onFocus="this.blur();"
				class="logbtn"><img src="../image/header/logout.gif" /></a></li>
		</ul>
		<div id="navi">
			<li class="design"><a href="../config/basic_config.html"
				onFocus="this.blur();"><span>환경설정</span></a></li>

			<!-- <li><a href="../basic/site_info.html" onFocus="this.blur();"><span>기본설정</span></a>
				<ul class="category">
					<li><a href="../basic/site_info.html">사이트정보</a></li>
					<li><a href="../basic/admin_list.html">관리자설정</a></li>
					<li><a href="../basic/popup_list.html">팝업관리</a></li>
					<li><a href="../basic/sms_fill.html">SMS관리</a></li>
				</ul>
			</li> -->


			<li><a href="../bbs/bbs_list.html" onFocus="this.blur();"><span>게시판관리</span></a>
				<ul class="category">
					<li><a href="../bbs/bbs_list.html">게시판관리</a></li>
					<li><a href="../bbs/bbs_manage_list.html">게시물통합관리</a></li>
					<li><a href="../bbs/bbs_manage_comment.html">코멘트통합관리</a></li>
				</ul></li>
			...
			<li><a href="../page/page_list.html"><span>페이지관리</span></a>
				<ul class="category">
					<li><a href="../page/page_list.html">페이지관리</a></li>
					<li class="depth"><a href="#" onFocus="this.blur();">페이지목록</a>
						<ul class="category_2depth">
							<li><a
								href="../page/page_input8312.html?mode=update&amp;idx=25">페이지추가1</a></li>
							<li><a
								href="../page/page_input5b7c.html?mode=update&amp;idx=26">페이지추가2</a></li>
						</ul></li>
				</ul></li>

			<li><a href="../connect/connect_list.html"
				onFocus="this.blur();"><span>접속통계</span></a>
				<ul class="category">
					<li><a href="../connect/connect_list.html">접속자분석</a></li>
				</ul></li>
